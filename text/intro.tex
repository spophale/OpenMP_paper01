...
work-sharing constructs and target data regions. The new OpenMP 4.5 release provides a substantial 
...
\begin{figure}[h]
  ...
  \includegraphics[height=0.3\textwidth]{./Images/crest.pdf}
       \caption{NUMA distances on a two socket POWER8 processor as reported by \textit{numactl}}
       \label{fig:crest}
\end{figure}
