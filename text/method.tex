We look closely at the different hardware counters available on the new POWER8 system to better understand the effects of data affinity and thread placement. For this work we focus on the memory subsystem, including \textbf{data cache} stall cycles. %to better understand the overhead of using different \textit{bind} and \textit{place} configurations. Stalls due to 
